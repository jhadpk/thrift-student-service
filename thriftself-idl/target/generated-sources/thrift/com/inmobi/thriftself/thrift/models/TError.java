...
public class TError extends Exception implements org.apache.thrift.TBase<TError, TError._Fields>, java.io.Serializable, Cloneable {
  ...
  public TError setCode(String code) {
    this.code = code;
    return this;
  }
  ...
  public TError setMessage(String message) {
    this.message = message;
    return this;
  }
  ...
  public int compareTo(TError other) {
    ...
    TError typedOther = (TError)other;
